...
color sean     " 设置背景主题  
"color torte     " 设置背景主题  
set guifont=Ubuntu_Mono:h12   " 设置字体  
...
func SetTitle() 
    ...
    elseif &filetype == 'python'
        ...
        call append(line(".")+1, "	> Author: CCTV-1") 
...
func! CompileRunGcc()
    exec "w"
    if &filetype == 'c'
        exec "!gcc -Wall -Wextra -pedantic -std=c11 -lm -O3 -m64 % -o %<"
        exec "!time ./%<"
    elseif &filetype == 'cpp'
        exec "!g++ -Wall -Wextra -pedantic -std=c++14 -O3 -m64 -lm -lstdc++ % -o %<"
        exec "!time ./%<"
    elseif &filetype == 'sh'
        exec "!time bash ./%"
    elseif &filetype == 'python'
...
func! Rungdb()
    exec "w"
    if &filetype == 'c'
        exec "!gcc -Wall -Wextra -pedantic -g -std=c11 -lm % -o %< -O0 -m64"
        exec "!gdb %<"
    elseif &filetype == 'cpp'
        exec "!g++ -Wall -Wextra -pedantic -g -std=c++14 -lm -lstdc++ % -o %< -O0 -m64"
        exec "!gdb %<"
    endif
endfunc
...
set encoding=utf8			"设置gvim内部编码，默认不更改
